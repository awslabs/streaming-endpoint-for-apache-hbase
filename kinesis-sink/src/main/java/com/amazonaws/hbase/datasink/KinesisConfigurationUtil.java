...
public class KinesisConfigurationUtil extends ConfigurationUtil {
	...
	public static final String KPL_RECORD_MAX_BUFFEREDTIME =
			REPLICATIOM_KINESIS+".recordmaxbufferedtime";
	...
	protected KinesisProducerConfiguration getKPLConfiguration() {
		this.kplConfig = new KinesisProducerConfiguration()
				...
				.setRecordMaxBufferedTime(this.getRecordMaxBufferedtime());
	...
	public Long getRecordMaxBufferedtime() {
		return this.conf.getLong(KPL_RECORD_MAX_BUFFEREDTIME, 100L);
	}
